...
function rpsls(move) {
    console.log('This is our player move: ' + move)
    // First we need to define what moves are possible
    const moves = ['rock', 'paper', 'scissors', 'lizard', 'spock']
    console.log('These are the possible moves: ' + moves)
    // Then we need to be able to get a random move for our player2 robot
    const randomNum= Math.floor([Math.random() * 5])
    console.log('This is our random index: ' + randomNum)
    console.log('This should be rock: ' + moves[0])
    //opponent's move
    const randomMove = moves[randomNum]
    console.log('This is our random move: ')
    ...
    console.log('This is our final_result: ' + final_result)
    return final_result
}